    ...
    <section className='font-sans relative' id='About' data-section>
      ...
      <article className='px-6 space-y-5 text-slate-400 *:leading-7 pt-4 md:pt-0'>
        <p>
          ...
          both technology and business, even strong ideas can fail due to poor
          execution.
        </p>
        <p>
          I’m a <span className='bold'>website</span> and
          <span className='bold'> mobile application developer</span> who helps
          startups and growing businesses turn ideas into scalable,
          high-performing websites and mobile applications. When an idea is
          built right, it feels like the exact solution users have been
          searching for, and that’s where real conversions happen.
        </p>
        <p>
          I have 4+ years of experience helping founders move from “just an
          idea” to MVP products that attract users and convert effectively. If
          you have an idea you want to grow, let’s talk. I’m happy to learn
          about your goals, timeline, budget, and what success looks like for
          your team.
        </p>
        <p>
